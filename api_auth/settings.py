...
APPLICATION_MODEL = getattr(settings, "OAUTH2_PROVIDER_APPLICATION_MODEL", "partner_api.Application")
ACCESS_TOKEN_MODEL = getattr(settings, "OAUTH2_PROVIDER_ACCESS_TOKEN_MODEL", "partner_api.AppToken")
...
DEFAULTS = {
    "CLIENT_ID_GENERATOR_CLASS": "partner_api.generators.ClientIdGenerator",
    "CLIENT_SECRET_GENERATOR_CLASS": "partner_api.generators.ClientSecretGenerator",
