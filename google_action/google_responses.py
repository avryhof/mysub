...
class GoogleResponse(object):
    ...
    def simple_response(self, text_response):
        resp = {
            ...
            "prompt": {"override": False, "firstSimple": {"speech": text_response, "text": text_response}},
        }
    ...
    def stream_song(self, song):
        ...
        resp = {
            ...
            "prompt": {
                        ...
                        "mediaObjects": [
                            {
                                ...
                                "url": song_url,
                                "image": {
                                    "large": {"alt": song.get("title"), "height": 0, "url": cover_url, "width": 0}
                                },
                            }
                        ],
                        "mediaType": "AUDIO",
                ...
                "firstSimple": {"speech": "Playing %s" % song.get("title"), "text": "Playing %s" % song.get("title")},
            },
        }
